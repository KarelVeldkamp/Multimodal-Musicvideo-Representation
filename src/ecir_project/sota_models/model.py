...
from thesis_project.sota_models.modules import Conv_1d, ResSE_1d, Conv_2d, Res_2d, Conv_V, Conv_H, HarmonicSTFT, Res_2d_mp
from thesis_project.sota_models.attention_modules import BertConfig, BertEncoder, BertEmbeddings, BertPooler, PositionalEncoding
...
# musicnn without the classification layers
class MusicnnNoClassifier(nn.Module):
    '''
    Pons et al. 2017
    End-to-end learning for music audio tagging at scale.
    This is the updated implementation of the original paper. Referred to the Musicnn code.
    ...
    def __init__(self,
                ...
                n_class=50,
                dataset='mtat'):
        super(MusicnnNoClassifier, self).__init__()
